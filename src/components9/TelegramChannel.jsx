  ...
  return (
    <section className="flex flex-col items-start pt-8 pr-20 pb-12 pl-10 mx-auto w-full rounded-3xl bg-zinc-900 max-md:px-5 max-md:mt-5 max-md:max-w-full">
      ...
      <div className="flex gap-2.5 mt-10">
        <img
          loading="lazy"
          src="https://cdn.builder.io/api/v1/image/assets/TEMP/5757d998a66e08f01504391979f51db878791af7af4dc6698a128a7c63ae3c42?placeholderIfAbsent=true&apiKey=f19410a7ed964887a882a08cb3ad097c"
