...
function Newsletter() {
  return (
    <section className="self-center mt-5 w-full max-w-[1252px] max-md:max-w-full">
        ...
        <div className="flex flex-col ml-5 w-6/12 max-md:ml-0 max-md:w-full">
          <div className="flex flex-col items-start pt-8 pr-20 pb-12 pl-10 mx-auto w-full rounded-3xl bg-zinc-900 max-md:px-5 max-md:mt-5 max-md:max-w-full">
            ...
            <div className="flex gap-2.5 mt-10">
              <img
                loading="lazy"
                src="https://cdn.builder.io/api/v1/image/assets/TEMP/8d0c176b3f83b0599b2bb3fa581d748c4c47f609e156d34e72399c5d6c727801?placeholderIfAbsent=true&apiKey=f19410a7ed964887a882a08cb3ad097c"
